...
public class DriverDataOfSpecificManufacturerTest {
    ...
    String twoProductTypesWithModels = docType+"<driver-data>"+
	    ...
	    "</product-type>"+
	    "</driver-data>";
    String oneModelNumberWithPostData = docType+"<driver-data>"+
	    "<product-type name='laptop'>"+
	        "<model-number name='123456' url='http://www.man1.com/123456'>"+
	        	"<post name='n1' value='v1'/>"+
	        	"<post name='n2' value='v2'/>"+
	        "</model-number>"+
	    "</product-type>"+
	    "</driver-data>";
    ...
    public void testReadData_getProductTypes_EmptyFile() throws Exception {
        ...
        assertEquals(1, productTypes.size()); // including 'All'
    }
    ...
    public void testReadData_getProductTypes_One() throws Exception {
        ...
        instance.readData(inStream);
        ArrayList<String> productTypes = instance.getProductTypes();
        assertEquals(2, productTypes.size()); // including 'All'
        assertEquals("All", productTypes.get(0));
    ...
    public void testReadData_getProductTypes_Two() throws Exception {
        ...
        instance.readData(inStream);
        ArrayList<String> productTypes = instance.getProductTypes();
        assertEquals(3, productTypes.size()); // including 'All'
        assertEquals("All", productTypes.get(0));
        assertEquals("laptop", productTypes.get(1));
        assertEquals("desktop", productTypes.get(2));
    }
    ...
    public void testReadData_emptyFile_AddTwoProductTypes_Alphabetically() throws Exception {
        ...
        assertEquals("All", productTypes.get(0));
        assertEquals("laptop", productTypes.get(1));
        assertEquals("pc", productTypes.get(2));
    }
    ...
    public void testReadData_GetActiveUrl_NoFileRead() throws Exception {
        DriverDataOfSpecificManufacturer instance = new DriverDataOfSpecificManufacturer();
        PostableUrl url = instance.getURL(0);
    ...
    public void testReadData_GetActiveUrl_Present() throws Exception {
        ...
        instance.readData(inStream);
        PostableUrl url = instance.getURL(0);
        assertEquals("http://www.man1.com/123456", url.getLink());
        assertEquals(null, url.getPostData());
    }

    @Test
    public void testReadData_GetActiveUrlAndPostData() throws Exception {
        DriverDataOfSpecificManufacturer instance = new DriverDataOfSpecificManufacturer();
        InputStream inStream = new ByteArrayInputStream(oneModelNumberWithPostData.getBytes());
        instance.readData(inStream);
        PostableUrl url = instance.getURL(0);
        assertEquals("http://www.man1.com/123456", url.getLink());
        Map<String, String> post = url.getPostData();
        assertEquals(post.size(), 2);
        assertEquals(post.get("n1"), "v1");
        assertEquals(post.get("n2"), "v2");
    }
    ...
    public void testReadData_GetActiveUrl_Second() throws Exception {
        ...
        InputStream inStream = new ByteArrayInputStream(twoModelNumbers.getBytes());
        instance.readData(inStream);
        PostableUrl url = instance.getURL(1);
        assertEquals("http://www.man1.com/987654", url.getLink());
        assertEquals(null, url.getPostData());
    }
    ...
    @Test
    public void testReadDataWithPostParamsAndSave() throws Exception {
        DriverDataOfSpecificManufacturer instance = new DriverDataOfSpecificManufacturer();
        InputStream inStream = new ByteArrayInputStream(oneModelNumberWithPostData.getBytes());
        instance.readData(inStream);
        ByteArrayOutputStream outStream = new ByteArrayOutputStream();
        ...
        String result = new String(outStream.toByteArray());
        result = result.replace('"', '\'');
        assertEquals(result, oneModelNumberWithPostData);
    }
    ...
    public void testReadData_AddProductType_Before() throws Exception {
        ...
        assertEquals("laptop", productTypes.get(2));
    }
    ...
    public void testReadData_AddProductType_After() throws Exception {
        ...
        assertEquals("All", productTypes.get(0));
        assertEquals("laptop", productTypes.get(1));
        assertEquals("towers", productTypes.get(2));
    }
