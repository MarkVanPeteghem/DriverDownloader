...
public class SelectedDownload {
    ...
    SelectedDownload(IDriverDownloader driverDownloader, String model, String url, File directory)  {
    ...
    void handle() throws Exception {
        ...
        try {
            ...
            driverDownloader.download(new PostableUrl(url), directory.getAbsolutePath());
